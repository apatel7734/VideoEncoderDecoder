...
public class ImageSprite {
    ...
    public ImageSprite(Context context) {
        mContext = context;
        initTextureWithMove();
    }

    private void initTextureWithMove() {
        ...
        int vertexShader = SurfaceRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = SurfaceRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
